...
1. From the **Trace** view you opened in the previous step, click the image:log_icon.png[log icon, 18, 18] **Log icon** on the right side of the span entry in the **Service & Operation** table.
