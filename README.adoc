...
:page-description: Learn how to enable the collection of traces, metrics, and logs from microservices by using MicroProfile Telemetry.
...
= Enabling observability in microservices with traces, metrics, and logs using OpenTelemetry

[.hidden]
NOTE: This repository contains the guide documentation source. To view the guide in published form, view it on the https://openliberty.io/guides/{projectid}.html[Open Liberty website].

Learn how to enable the collection of traces, metrics, and logs from microservices by using MicroProfile Telemetry.
...
For a complete list of the default metrics that Open Liberty collects when MicroProfile Telemetry is enabled, see the https://openliberty.io/docs/latest/mptelemetry-metrics-list.html[MicroProfile Telemetry metrics reference list^].
...
+
image::inventory_metrics.png[Inventory service metrics,align="center"]
...
By default, OpenTelemetry collects only message logs. To enable the MicroProfile Telemetry feature to collect logs from different sources in Open Liberty, set the `source` attribute of the https://openliberty.io/docs/latest/reference/config/mpTelemetry.html[mpTelemetry^] element to a comma-separated list of sources.
